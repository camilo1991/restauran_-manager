...
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
  	<li><?php echo $this->Html->link(__('Editar Mesero'), array('action' => 'edit', $mesero['Mesero']['id'])); ?></li>
  	<li><?php echo $this->Form->postLink(__('eliminar  Mesero'), array('action' => 'delete', $mesero['Mesero']['id']), array(), __('Are you sure you want to delete # %s?', $mesero['Mesero']['id'])); ?></li>
  	<li><?php echo $this->Html->link(__('Lista Meseros'), array('action' => 'index')); ?></li>
  	<li><?php echo $this->Html->link(__('nueva Mesero'), array('action' => 'add')); ?></li>
    <li class="divider"></li>
